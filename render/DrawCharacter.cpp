...
void cDrawCharacter::Draw(const cCharacter &character, double link_width, const tVector &fill_col,
...
void cDrawCharacter::DrawShape(const cCharacter &character, const cKinTree::tDrawShapeDef &def,
...
void cDrawCharacter::DrawHeading(const cCharacter &character, double arrow_size, const tVector &arrow_col,
...
void cDrawCharacter::DrawShapeBox(const cCharacter &character, const cKinTree::tDrawShapeDef &def,
                                  const tVector &fill_tint, const tVector &line_col) {
    double theta = 0;
    ...
    tVector size =
        tVector(def[cKinTree::eDrawShapeParam0], def[cKinTree::eDrawShapeParam1], def[cKinTree::eDrawShapeParam2], 0);
...
void cDrawCharacter::DrawShapeCapsule(const cCharacter &character, const cKinTree::tDrawShapeDef &def,
                                      const tVector &fill_tint, const tVector &line_col) {
    double theta = 0;
