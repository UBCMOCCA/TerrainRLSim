...
class cMeshUtil {
  public:
    enum eAttribute { eAttributePosition, eAttributeNormal, eAttributeCoord, eAttributeMax };
    ...
    static void RayTest(const tVector &start, const tVector &end, const cDrawMesh &mesh,
  ...
  protected:
    static bool RayIntersectTriangle(const tVector &start, const tVector &end, const tVector &v0, const tVector &v1,
