...
class cPostProcessor {
  public:
    ...
    void BlurTexture(const cTextureDesc &input, const cTextureDesc &intermediate, const cTextureDesc &output,
                     float offset) const;
  ...
  private:
    ...
    void CrepuscularRay(const cTextureDesc &input, const cTextureDesc &intermediate, const cTextureDesc &output) const;
    void BloomPass(const cTextureDesc &input, const cTextureDesc &tex0, const cTextureDesc &tex1,
    ...
    void BloomComposite(const cTextureDesc &input0, const cTextureDesc &input1, const cTextureDesc &input2,
                        const cTextureDesc &input3, const cTextureDesc &input4, const cTextureDesc &output) const;
    void BrightPass(const cTextureDesc &input, const cTextureDesc &lum_tex, const cTextureDesc &output) const;
    void Blur(const cTextureDesc &input, const cTextureDesc &intermediate, const cTextureDesc &output,
              float offset) const;
    void BlurPass(const cTextureDesc &input, const cTextureDesc &output, float offset_x, float offset_y) const;
    ...
    void DrawPostFX(const cTextureDesc **const input_tex, int num_tex, const cTextureDesc &output,
