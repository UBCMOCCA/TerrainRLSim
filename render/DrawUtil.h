...
class cDrawUtil {
  public:
    enum eDrawMode { eDrawSolid, eDrawWire, eDrawMax };
    ...
    static void DrawBox(const tVector &pos, const tVector &size, const tVector &tex_coord_min,
                        const tVector &tex_coord_max, eDrawMode draw_mode = eDrawSolid);
    ...
    static void DrawQuad(const tVector &a, const tVector &b, const tVector &c, const tVector &d, const tVector &coord_a,
                         const tVector &coord_b, const tVector &coord_c, const tVector &coord_d,
                         eDrawMode draw_mode = eDrawSolid);
    ...
    static void DrawRuler2D(const tVector &origin, const tVector &size, const tVector &col, double marker_spacing,
    ...
    static void DrawSemiCircle(const tVector &pos, double r, int slices, double min_theta, double max_theta,
                               eDrawMode draw_mode = eDrawSolid);
    static void DrawCalibMarker(const tVector &pos, double r, int slices, const tVector &col0, const tVector &col1,
                                eDrawMode draw_mode = eDrawSolid);
    ...
    // static void setShaderRelativePath(const std::string path);
    static std::string mRelativePath;
  ...
  protected:
    ...
    static void DrawBoxSolid(const tVector &pos, const tVector &size, const tVector &tex_coord_min,
