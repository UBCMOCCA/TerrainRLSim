...
class cTextureDesc {
  public:
    cTextureDesc(int width, int height, int channels, GLenum format, GLenum type, bool mipmaps);
    cTextureDesc(int width, int height, int depth, int channels, GLenum format, GLenum type, bool mipmaps);
    cTextureDesc(GLuint obj, GLuint tex, GLuint ds, int width, int height, int depth, int channels, GLenum format);
