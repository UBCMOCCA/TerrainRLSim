...
class cSkyBox {
  ...
  private:
    ...
    void PreethamSky(const tVector &dir, const tVector &sun_dir, float *output);

    float PrezeHosekLuminance(float cos_theta, float cos_gamma, float A, float B, float C, float D, float E, float F,
