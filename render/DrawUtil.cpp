...
void cDrawUtil::DrawBox(const tVector &pos, const tVector &size, const tVector &tex_coord_min,
...
void cDrawUtil::DrawBoxSolid(const tVector &pos, const tVector &size, const tVector &tex_coord_min,
    ...
    const float pos_data[pos_len] = {ne0[0], ne0[1], ne0[2], // top
                                     nw0[0], nw0[1], nw0[2], nw1[0], nw1[1], nw1[2], nw1[0], nw1[1],
                                     nw1[2], ne1[0], ne1[1], ne1[2], ne0[0], ne0[1], ne0[2],

                                     se1[0], se1[1], se1[2], // bottom
                                     sw1[0], sw1[1], sw1[2], sw0[0], sw0[1], sw0[2], sw0[0], sw0[1],
                                     sw0[2], se0[0], se0[1], se0[2], se1[0], se1[1], se1[2],

                                     se1[0], se1[1], se1[2], // front
                                     se0[0], se0[1], se0[2], ne0[0], ne0[1], ne0[2], ne0[0], ne0[1],
                                     ne0[2], ne1[0], ne1[1], ne1[2], se1[0], se1[1], se1[2],

                                     sw0[0], sw0[1], sw0[2], // back
                                     sw1[0], sw1[1], sw1[2], nw1[0], nw1[1], nw1[2], nw1[0], nw1[1],
                                     nw1[2], nw0[0], nw0[1], nw0[2], sw0[0], sw0[1], sw0[2],

                                     sw0[0], sw0[1], sw0[2], // left
                                     nw0[0], nw0[1], nw0[2], ne0[0], ne0[1], ne0[2], ne0[0], ne0[1],
                                     ne0[2], se0[0], se0[1], se0[2], sw0[0], sw0[1], sw0[2],

                                     se1[0], se1[1], se1[2], // right
                                     ne1[0], ne1[1], ne1[2], nw1[0], nw1[1], nw1[2], nw1[0], nw1[1],
                                     nw1[2], sw1[0], sw1[1], sw1[2], se1[0], se1[1], se1[2]};

    const float coord_data[coord_len] = {
        tex_coord_min[0], tex_coord_min[2], // top
        tex_coord_max[0], tex_coord_min[2], tex_coord_max[0], tex_coord_max[2], tex_coord_max[0],
        tex_coord_max[2], tex_coord_min[0], tex_coord_max[2], tex_coord_min[0], tex_coord_min[2],

        tex_coord_max[0], tex_coord_min[2], // bottom
        tex_coord_max[0], tex_coord_max[2], tex_coord_min[0], tex_coord_max[2], tex_coord_min[0],
        tex_coord_max[2], tex_coord_min[0], tex_coord_min[2], tex_coord_max[0], tex_coord_min[2],

        tex_coord_min[0], tex_coord_min[1], // front
        tex_coord_max[0], tex_coord_min[1], tex_coord_max[0], tex_coord_max[1], tex_coord_max[0],
        tex_coord_max[1], tex_coord_min[0], tex_coord_max[1], tex_coord_min[0], tex_coord_min[1],
        ...
        tex_coord_max[2], tex_coord_max[1], tex_coord_min[2], tex_coord_max[1], tex_coord_min[2],
        tex_coord_max[1], tex_coord_min[2], tex_coord_min[1], tex_coord_max[2], tex_coord_min[1],
    ...
    gBoxSolidMesh->LoadVBuffer(attr_info.mAttribNumber, sizeof(float) * coord_len, (GLubyte *)coord_data, 0, 1,
                               &attr_info);
...
void cDrawUtil::DrawBoxWire(const tVector &pos, const tVector &size) {
    ...
    const float pos_data[pos_len] = {
        ...
        nw0[0], nw0[1], nw0[2], nw0[0], nw0[1], nw0[2], nw1[0], nw1[1], nw1[2], nw1[0], nw1[1],
        nw1[2], ne1[0], ne1[1], ne1[2], ne1[0], ne1[1], ne1[2], ne0[0], ne0[1], ne0[2],

        se1[0], se1[1], se1[2], // bottom
        sw1[0], sw1[1], sw1[2], sw1[0], sw1[1], sw1[2], sw0[0], sw0[1], sw0[2], sw0[0], sw0[1],
        sw0[2], se0[0], se0[1], se0[2], se0[0], se0[1], se0[2], se1[0], se1[1], se1[2],
...
void cDrawUtil::DrawQuad(const tVector &a, const tVector &b, const tVector &c, const tVector &d, eDrawMode draw_mode) {
    DrawQuad(a, b, c, d, tVector(0, 0, 0, 0), tVector(1, 0, 0, 0), tVector(1, 1, 0, 0), tVector(0, 1, 0, 0), draw_mode);
}

void cDrawUtil::DrawQuad(const tVector &a, const tVector &b, const tVector &c, const tVector &d, const tVector &coord_a,
                         const tVector &coord_b, const tVector &coord_c, const tVector &coord_d, eDrawMode draw_mode) {
    ...
    const float pos_data[pos_len] = {a[0], a[1], a[2], b[0], b[1], b[2], c[0], c[1], c[2], d[0], d[1], d[2]};

    const float norm_data[norm_len] = {normal[0], normal[1], normal[2], normal[0], normal[1], normal[2],
                                       normal[0], normal[1], normal[2], normal[0], normal[1], normal[2]};

    const float coord_data[coord_len] = {coord_a[0], coord_a[1], coord_b[0], coord_b[1],
                                         coord_c[0], coord_c[1], coord_d[0], coord_d[1]};
...
void cDrawUtil::DrawPoint(const tVector &pt) {
    ...
    const int pos_len = num_verts * cMeshUtil::gPosDim;
    const float pos_data[pos_len] = {pt[0], pt[1], pt[2]};
...
void cDrawUtil::DrawCross(const tVector &pos, double size) {
    DrawLine(tVector(pos[0] - 0.5 * size, pos[1], pos[2], 0), tVector(pos[0] + 0.5 * size, pos[1], pos[2], 0));
    DrawLine(tVector(pos[0], pos[1] - 0.5 * size, pos[2], 0), tVector(pos[0], pos[1] + 0.5 * size, pos[2], 0));
}
...
void cDrawUtil::DrawRuler2D(const tVector &origin, const tVector &size, const tVector &col, double marker_spacing,
                            double big_marker_spacing, double marker_h, double big_marker_h) {
    double w = size[0];
    double h = size[1];
...
void cDrawUtil::DrawSemiCircle(const tVector &pos, double r, int slices, double min_theta, double max_theta,
                               eDrawMode draw_mode) {
...
void cDrawUtil::DrawCalibMarker(const tVector &pos, double r, int slices, const tVector &col0, const tVector &col1,
                                eDrawMode draw_mode) {
    SetColor(col0);
...
void cDrawUtil::DrawTexQuad(const cTextureDesc &tex, const tVector &pos, const tVector &size) {
    ...
    DrawQuad(tVector(pos[0] - 0.5 * size[0], pos[1] - 0.5 * size[1], pos[2], 0),
             ...
             tVector(pos[0] + 0.5 * size[0], pos[1] + 0.5 * size[1], pos[2], 0),
             tVector(pos[0] - 0.5 * size[0], pos[1] + 0.5 * size[1], pos[2], 0), tVector(0, 0, 0, 0),
             tVector(1, 0, 0, 0), tVector(1, 1, 0, 0), tVector(0, 1, 0, 0), eDrawSolid);
...
void cDrawUtil::ClearColor(const tVector &col) {
    glClearColor(static_cast<float>(col[0]), static_cast<float>(col[1]), static_cast<float>(col[2]),
...
void cDrawUtil::GLMultMatrix(const tMatrix &mat) { glMultMatrixd(mat.data()); }

void cDrawUtil::PushMatrix() { glPushMatrix(); }

void cDrawUtil::PopMatrix() { glPopMatrix(); }
...
const cShader &cDrawUtil::GetCopyProg() { return gCopyProg; }

void cDrawUtil::Translate(const tVector &trans) { glTranslated(trans[0], trans[1], trans[2]); }

void cDrawUtil::Scale(const tVector &scale) { glScaled(scale[0], scale[1], scale[2]); }
...
void cDrawUtil::SetPointSize(double pt_size) { glPointSize(static_cast<float>(pt_size)); }
