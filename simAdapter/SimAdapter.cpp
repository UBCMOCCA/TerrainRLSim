...
void cSimAdapter::init() {
    ...
    if (_render) {
        ...
        if (scenario_name == "imitate_eval") {
            ...
            // std::shared_ptr<cDrawScenarioSimChar> scenario__ = std::shared_ptr<cDrawScenarioSimChar>(new
            // cDrawScenarioSimChar(gCamera));
            ...
            std::shared_ptr<cDrawScenarioSimChar> scenario__ =
                std::shared_ptr<cDrawScenarioSimChar>(new cDrawScenarioSimChar(gCamera));
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__->GetScene());
            this->_gScenario = scenario__;
            if (this->_gScenario != NULL) {
                auto sim_char_scene = std::dynamic_pointer_cast<cDrawScenarioTerrainRL>(scenario__);
            ...
            std::shared_ptr<cDrawScenarioSimChar> scenario__ =
                std::shared_ptr<cDrawScenarioImitateStepEval>(new cDrawScenarioImitateStepEval(gCamera));
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__->GetScene());
            this->_gScenario = scenario__;
            if (this->_gScenario != NULL) {
                auto sim_char_scene = std::dynamic_pointer_cast<cDrawScenarioTerrainRL>(scenario__);
            ...
            std::shared_ptr<cDrawScenarioSimChar> scenario__ =
                std::shared_ptr<cDrawScenarioHikeEval>(new cDrawScenarioHikeEval(gCamera));
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__->GetScene());
            this->_gScenario = scenario__;
            if (this->_gScenario != NULL) {
                auto sim_char_scene = std::dynamic_pointer_cast<cDrawScenarioTerrainRL>(scenario__);
            ...
            std::shared_ptr<cDrawScenarioSimChar> scenario__ =
                std::shared_ptr<cDrawScenarioSoccerEval>(new cDrawScenarioSoccerEval(gCamera));
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__->GetScene());
            this->_gScenario = scenario__;
            if (this->_gScenario != NULL) {
                auto sim_char_scene = std::dynamic_pointer_cast<cDrawScenarioTerrainRL>(scenario__);
    ...
    // else if (scenario_name == "sim_char_render")
        ...
        if (scenario_name == "imitate_eval") {
            ...
            std::shared_ptr<cScenarioSimChar> scenario__ =
                std::shared_ptr<cScenarioImitateStepEval>(new cScenarioImitateStepEval());
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__);
            // gScenario = std::shared_ptr<cScenario>(scenario__);
            this->_gScenario = scenario__;
        } else if (scenario_name == "hike_eval") {
            ...
            gCameraPosition = tVector(0, 30, 30, 0);
            std::shared_ptr<cScenarioSimChar> scenario__ =
                std::shared_ptr<cScenarioSoccerEval>(new cScenarioSoccerEval());
            this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__);
            this->_gScenario = scenario__;
        } else {
...
double cSimAdapter::calcReward() {
    ...
    // char_ = scene->getChar();
    std::shared_ptr<cTerrainRLCharController> controller =  std::static_pointer_cast< cTerrainRLCharController
    >(char_->GetController()); double reward_ = controller->CalcReward();
    */
    return reward_;
}
...
double cSimAdapter::updateAction(std::vector<double> act) {
    ...
    // ASSERT(controller->GetPoliActionSize() == act.size(),  "Action length (" << act.size() << ") incorrect, should be
    // " << controller->GetPoliActionSize());
...
double cSimAdapter::updateLLCAction(std::vector<double> act) {
    ...
    // std::shared_ptr<cWaypointController> controller =  std::static_pointer_cast< cWaypointController
    // >(char_->GetController());
...
std::vector<double> cSimAdapter::getState() const {
    ...
    std::shared_ptr<cTerrainRLCharController> controller =
        std::static_pointer_cast<cTerrainRLCharController>(char_->GetController());
    // const std::shared_ptr<cTerrainRLCharController>& controller =  static_cast< const
    // std::shared_ptr<cTerrainRLCharController>& >(char_->GetController()); controller = char->getCOntroller()
...
bool cSimAdapter::needUpdatedAction() {
    ...
    // std::cout << "Controller State: " << con_state_ << " last controller state: "<< _lastControllerState <<
    // std::endl;
    if (con_state_ == 0 && (_lastControllerState != 0)) {
        ...
        // std::shared_ptr<cDrawScenarioSimChar> scenario__ = std::shared_ptr<cDrawScenarioSimChar>(new
        // cDrawScenarioSimChar(gCamera)); this->_scene = std::shared_ptr<cScenarioSimChar>(scenario__->GetScene());
        return true;
    }
    _lastControllerState = con_state_;
