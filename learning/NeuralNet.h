...
class cNeuralNet {
  public:
    ...
    enum eOffsetScaleType { eOffsetScaleTypeNone, eOffsetScaleTypeFixed, eOffsetScaleTypeMax };
    ...
    static void CopyParams(const std::vector<caffe::Blob<tNNData> *> &src_params,
    ...
    static bool CompareParams(const std::vector<caffe::Blob<tNNData> *> &a_params,
    ...
    virtual void ForwardInjectNoisePrefilled(double mean, double stdev, const std::string &layer_name,
