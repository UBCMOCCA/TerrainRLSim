...
void cTrainerInterface::LoadCriticModel(const std::string &model_file) { LoadModel(model_file); }

void cTrainerInterface::LoadCriticScale(const std::string &scale_file) { LoadScale(scale_file); }

void cTrainerInterface::LoadActorModel(const std::string &model_file) { LoadModel(model_file); }

void cTrainerInterface::LoadActorScale(const std::string &scale_file) { LoadScale(scale_file); }

bool cTrainerInterface::HasActorInitModel() const { return HasInitModel(); }

bool cTrainerInterface::HasCriticInitModel() const { return HasInitModel(); }

bool cTrainerInterface::HasForwardDynamicsInitModel() const { return HasInitModel(); }
...
int cTrainerInterface::GetForwardDynamicsInputSize() const { return GetOutputSize(); }
int cTrainerInterface::GetForwardDynamicsOutputSize() const { return GetOutputSize(); }
...
void cTrainerInterface::SetForwardDynamicsInputOffsetScaleType(
...
void cTrainerInterface::SetForwardDynamicsInputOffsetScale(const Eigen::VectorXd &offset,
...
void cTrainerInterface::SetForwardDynamicsOutputOffsetScale(const Eigen::VectorXd &offset,
                                                            const Eigen::VectorXd &scale) {
    SetOutputOffsetScale(offset, scale);
}

void cTrainerInterface::OutputCritic(const std::string &filename) const { OutputModel(filename); }

void cTrainerInterface::OutputActor(const std::string &filename) const { OutputModel(filename); }
