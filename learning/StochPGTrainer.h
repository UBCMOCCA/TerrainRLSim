...
class cStochPGTrainer : public cCaclaTrainer {
  ...
  protected:
    ...
    virtual void ApplyEntropyWorker(int row_idx_min, int row_idx_max, const Eigen::MatrixXd *X, cNeuralNet *net,
                                    cNeuralNet::tProblem *out_prob);
    virtual void ApplyEntropyHelper(int row_idx, const Eigen::MatrixXd *X, cNeuralNet *net,
                                    cNeuralNet::tProblem *out_prob);
