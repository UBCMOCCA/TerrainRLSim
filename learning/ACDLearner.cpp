...
bool cACDLearner::HasForwardDynamicsNet() const { return mForwardDynamicsNet != nullptr; }
...
const cNeuralNet *cACDLearner::GetForwardDynamicsNet() const { return mForwardDynamicsNet; }
