...
void cOptimizer::OutputIntermediateResult(bool enable) { mEnableIntOutput = enable; }
...
void cOptimizer::OutputLog(const std::vector<double> &fit_vals, double final_val,
