...
void cScenarioRetargetMotion::Run() { RetargetMotions(mMotionFiles, mSrcChar, mDstChar); }

std::string cScenarioRetargetMotion::GetName() const { return "Retarget Motion"; }
...
void cScenarioRetargetMotion::RetargetMotions(const std::vector<std::string> &motion_files, cKinCharacter &src_char,
                                              cKinCharacter &dst_char) {
...
void cScenarioRetargetMotion::RetargetPose(const cKinCharacter &src_char, cKinCharacter &dst_char,
...
void cScenarioRetargetMotion::ConvertJointPose(const cKinCharacter &src_char, int src_j, const cKinCharacter &dst_char,
                                               int dst_j, Eigen::VectorXd &out_dst_joint_pose) const {
    ...
    } else if (src_type == cKinTree::eJointTypeSpherical && dst_type == cKinTree::eJointTypeRevolute) {
