...
void cScenarioSampleAction::SetTimeStep(double time_step) { mTimeStep = time_step; }

std::string cScenarioSampleAction::GetName() const { return "Sample Actions"; }
...
bool cScenarioSampleAction::HasOutputFile() const { return mOutputPath != ""; }
