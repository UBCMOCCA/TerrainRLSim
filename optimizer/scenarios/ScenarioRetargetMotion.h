...
class cScenarioRetargetMotion : public cScenario {
  ...
  protected:
    ...
    virtual void RetargetMotions(const std::vector<std::string> &motion_files, cKinCharacter &src_char,
    ...
    virtual void ConvertJointPose(const cKinCharacter &src_char, int src_j, const cKinCharacter &dst_char, int dst_j,
                                  Eigen::VectorXd &out_dst_joint_pose) const;
};
