...
cScenarioProcessMocap::cScenarioProcessMocap() { mTargetFramerate = 0; }
...
void cScenarioProcessMocap::Run() { ConvertMocapFiles(mInputFiles, mOutputPath); }

std::string cScenarioProcessMocap::GetName() const { return "Process Mocap"; }

void cScenarioProcessMocap::ConvertMocapFiles(const std::vector<std::string> &input_files,
