...
class cScenarioTrainCacla : public cScenarioTrain {
  ...
  protected:
    enum eCaclaTrainerType {
        ...
        eCaclaTrainerTypeSARSA,
        eCaclaTrainerTypeStoch,
    ...
    virtual void SetupTrainerStoch(const std::shared_ptr<cStochPGTrainer> &out_trainer);

    virtual void BuildExpScene(int id, std::shared_ptr<cScenarioExp> &out_exp) const;

    virtual void SetupLearner(const std::shared_ptr<cSimCharacter> &character,
