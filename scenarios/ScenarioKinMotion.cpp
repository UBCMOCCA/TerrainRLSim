...
cScenarioKinMotion::cScenarioKinMotion() { mCharInitPos.setZero(); }
...
void cScenarioKinMotion::Reset() { mChar.Reset(); }

void cScenarioKinMotion::Clear() { mChar.Clear(); }

void cScenarioKinMotion::Update(double time_elapsed) { mChar.Update(time_elapsed); }

const cKinCharacter &cScenarioKinMotion::GetCharacter() const { return mChar; }

tVector cScenarioKinMotion::GetCharPos() const { return GetCharacter().GetRootPos(); }

double cScenarioKinMotion::GetTime() const { return mChar.GetTime(); }

std::string cScenarioKinMotion::GetName() const { return "Kinematic Motion"; }
