...
std::string cScenarioMimic::GetName() const { return "Mimic"; }
...
void cScenarioMimic::UpdateExpScene(double time_step, int exp_id, std::shared_ptr<cScenarioExp> &out_exp,
                                    bool &out_done) {
...
void cScenarioMimic::SetupLearner(const std::shared_ptr<cSimCharacter> &character,
...
void cScenarioMimic::SetupTrainerOffsetScale(const std::shared_ptr<cTrainerInterface> &out_trainer) {
    ...
    if (!valid_init_model) {
        int char_ctrl_id = GetCharCtrlID();
        std::shared_ptr<cMixController> mix_ctrl =
            std::static_pointer_cast<cMixController>(cScenarioTrain::GetDefaultController());
        std::shared_ptr<cNNController> ctrl =
            std::static_pointer_cast<cNNController>(mix_ctrl->GetController(char_ctrl_id));
