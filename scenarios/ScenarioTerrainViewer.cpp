...
cScenarioTerrainViewer::cScenarioTerrainViewer() { mTargetCharPos.setZero(); }
...
void cScenarioTerrainViewer::SetTargetCharPos(const tVector &pos) { mTargetCharPos = pos; }

std::string cScenarioTerrainViewer::GetName() const { return "Terrain Viewer"; }

void cScenarioTerrainViewer::UpdateCharacter(double time_step) { MoveCharacter(mTargetCharPos); }
