...
cScenarioTrainMACE::cScenarioTrainMACE() {
    ...
    mInitExpParams.mBaseActionRate = 0.9;
}

cScenarioTrainMACE::~cScenarioTrainMACE() {}

std::string cScenarioTrainMACE::GetName() const { return "Train MACE"; }
...
void cScenarioTrainMACE::BuildExpScene(int id, std::shared_ptr<cScenarioExp> &out_exp) const {
