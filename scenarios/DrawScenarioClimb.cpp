...
cDrawScenarioClimb::cDrawScenarioClimb(cCamera &cam) : cDrawScenarioTrackMotion(cam) {}

cDrawScenarioClimb::~cDrawScenarioClimb() {}

void cDrawScenarioClimb::Update(double time_elapsed) { cDrawScenarioTrackMotion::Update(time_elapsed); }
