...
cDrawScenarioImitateStep::cDrawScenarioImitateStep(cCamera &cam) : cDrawScenarioImitateTarget(cam) {}
...
void cDrawScenarioImitateStep::DrawStepPlan() const {
    ...
    const tVector &pos1_col = tVector(0, 0.0, 0.5, 0.5);
...
void cDrawScenarioImitateStep::DrawRootHeading(const cBipedStepController3D::tStepPlan &step_plan,
