...
cDrawScenarioTrain::cDrawScenarioTrain(cCamera &cam) : cDrawScenarioSimChar(cam) {}
...
void cDrawScenarioTrain::Update(double time_elapsed) { cDrawScenarioSimChar::Update(time_elapsed); }
...
void cDrawScenarioTrain::Shutdown() { mTrain->Shutdown(); }
...
void cDrawScenarioTrain::SetupTrainScene(std::shared_ptr<cScenarioTrain> &out_train_scene,
...
std::string cDrawScenarioTrain::GetName() const { return mTrain->GetName(); }
