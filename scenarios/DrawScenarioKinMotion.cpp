...
cDrawScenarioKinMotion::cDrawScenarioKinMotion(cCamera &cam) : cDrawScenarioTerrainRL(cam) {}
...
std::string cDrawScenarioKinMotion::GetName() const { return mScene.GetName(); }

void cDrawScenarioKinMotion::UpdateScene(double time_elapsed) { mScene.Update(time_elapsed); }

tVector cDrawScenarioKinMotion::GetCamTrackPos() const { return mScene.GetCharPos(); }

tVector cDrawScenarioKinMotion::GetCamStillPos() const { return mScene.GetCharPos(); }

tVector cDrawScenarioKinMotion::GetDefaultCamFocus() const { return gCamFocus0; }
...
void cDrawScenarioKinMotion::DrawGround2D() const {
    ...
    cDrawUtil::DrawRuler2D(pos, size, ground_col, marker_spacing, big_marker_spacing, marker_h, big_marker_h);
}
...
bool cDrawScenarioKinMotion::EnableAnnotation() const { return (mAnnotateOutputFile != ""); }
