...
cScenarioTrainMACEDPG::cScenarioTrainMACEDPG() { mTrainerTempScale = 1; }
...
std::string cScenarioTrainMACEDPG::GetName() const { return "Train MACE DPG"; }
...
void cScenarioTrainMACEDPG::SetupLearner(const std::shared_ptr<cSimCharacter> &character,
