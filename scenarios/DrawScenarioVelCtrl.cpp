...
cDrawScenarioVelCtrl::cDrawScenarioVelCtrl(cCamera &cam) : cDrawScenarioTrackMotion(cam) {}

cDrawScenarioVelCtrl::~cDrawScenarioVelCtrl() {}

void cDrawScenarioVelCtrl::Update(double time_elapsed) { cDrawScenarioTrackMotion::Update(time_elapsed); }
