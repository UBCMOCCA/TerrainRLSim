...
cDrawScenarioTerrainViewer::cDrawScenarioTerrainViewer(cCamera &cam) : cDrawScenarioSimChar(cam) {
...
tVector cDrawScenarioTerrainViewer::GetCamTrackPos() const { return mCam.GetFocus(); }

tVector cDrawScenarioTerrainViewer::GetCamStillPos() const { return mCam.GetFocus(); }
