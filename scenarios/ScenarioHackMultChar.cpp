...
const std::shared_ptr<cSimCharacter> &cScenarioHackMultChar::GetHackCharacter() const { return mChar1; }

std::string cScenarioHackMultChar::GetName() const { return "Hack Multiple Characters"; }
...
void cScenarioHackMultChar::BuildChar1() {
    ...
    if (succ) {
        ...
        ctrl_params.mNetFiles[cTerrainRLCtrlFactory::eNetFileActor] =
            "data/policies/raptor/nets/raptor_mace3_deploy.prototxt";
        ctrl_params.mNetFiles[cTerrainRLCtrlFactory::eNetFileActorModel] =
            "data/policies/raptor/models/raptor_mace3_slopes_mixed_model.h5";
