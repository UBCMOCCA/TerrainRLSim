...
double cScenarioPoliEval::GetAvgDist() const { return mAvgDist; }
...
int cScenarioPoliEval::GetNumEpisodes() const { return mEpisodeCount; }

int cScenarioPoliEval::GetNumTotalCycles() const { return mTotalCycles; }

const std::vector<double> &cScenarioPoliEval::GetDistLog() const { return mDistLog; }

const std::vector<double> &cScenarioPoliEval::GetRewardLog() const { return mRewardLog; }
...
std::string cScenarioPoliEval::GetName() const { return "Policy Evaluation"; }
...
bool cScenarioPoliEval::EnableRandInitAction() const { return false; }
...
double cScenarioPoliEval::GetCurrCumulativeReward() const { return mTotalReward; }
...
void cScenarioPoliEval::InitCtrlForceRecord(const std::string &out_file) const { cFileUtil::ClearFile(out_file); }
...
bool cScenarioPoliEval::EnableRecordActions() const { return mRecordActions && mActionOutputFile != ""; }
...
bool cScenarioPoliEval::EnableRecordCtrlForce() const { return mRecordCtrlForce && mCtrlForceOutputFile != ""; }
...
void cScenarioPoliEval::InitActionIDState(const std::string &out_file) const { cFileUtil::ClearFile(out_file); }
...
void cScenarioPoliEval::UpdateTotalReward(double curr_reward) { mTotalReward += curr_reward; }
...
void cScenarioPoliEval::ClearMisc() { ResetRecord(); }

void cScenarioPoliEval::ResetMisc() { mPosStart = mChar->GetRootPos(); }
...
void cScenarioPoliEval::HandleEpisodeEnd() { EndEpisodeRecord(); }
