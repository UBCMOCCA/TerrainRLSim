...
void cScenarioImitateEval::SetResetPhaseSamples(int num_samples) { mResetPhaseSamples = num_samples; }

std::string cScenarioImitateEval::GetName() const { return "Imitate Evaluation"; }
