...
cCharacter::cCharacter() { ResetParams(); }
...
tQuaternion cCharacter::GetRootRotation() const { return cKinTree::GetRootRot(mJointMat, mPose); }

void cCharacter::SetRootPos(const tVector &pos) { cKinTree::SetRootPos(mJointMat, pos, mPose); }

void cCharacter::SetRootPos0(const tVector &pos) { cKinTree::SetRootPos(mJointMat, pos, mPose0); }

void cCharacter::SetRootRotation(const tQuaternion &q) { cKinTree::SetRootRot(mJointMat, q, mPose); }

tQuaternion cCharacter::CalcHeadingRot() const { return cKinTree::CalcHeadingRot(mJointMat, mPose); }

double cCharacter::CalcHeading() const { return cKinTree::CalcHeading(mJointMat, mPose); }

tMatrix cCharacter::BuildOriginTrans() const { return cKinTree::BuildOriginTrans(mJointMat, mPose); }
...
int cCharacter::GetParentJoint(int joint_id) const { return cKinTree::GetParent(mJointMat, joint_id); }
...
double cCharacter::GetJointDiffWeight(int joint_id) const { return cKinTree::GetJointDiffWeight(mJointMat, joint_id); }

bool cCharacter::WriteState(const std::string &file) const { return WriteState(file, tMatrix::Identity()); }
...
bool cCharacter::LoadSkeleton(const Json::Value &root) { return cKinTree::Load(root, mJointMat); }
...
void cCharacter::setRelativeFilePath(std::string path) { _relativeFilePath = path; }

std::string cCharacter::getRelativeFilePath() { return _relativeFilePath; }
