...
double cIKSolver::CalcObjVal(const Eigen::MatrixXd &joint_desc, const Eigen::VectorXd &pose,
...
Eigen::VectorXd cIKSolver::BuildErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
...
Eigen::VectorXd cIKSolver::BuildConsPosErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                           const tConsDesc &cons_desc, double clamp_dist) {
...
Eigen::VectorXd cIKSolver::BuildConsPosXErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                            const tConsDesc &cons_desc, double clamp_dist) {
...
Eigen::VectorXd cIKSolver::BuildConsPosYErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                            const tConsDesc &cons_desc, double clamp_dist) {
...
Eigen::VectorXd cIKSolver::BuildConsThetaErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                             const tConsDesc &cons_desc) {
...
Eigen::VectorXd cIKSolver::BuildConsThetaWorldErr(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                                  const tConsDesc &cons_desc) {
...
Eigen::MatrixXd cIKSolver::BuildJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                      const Eigen::MatrixXd &cons_mat) {
...
Eigen::MatrixXd cIKSolver::BuildConsPosJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                             const tConsDesc &cons_desc) {
    assert(static_cast<int>(cons_desc(eConsDescType)) == eConsTypePos);
...
Eigen::MatrixXd cIKSolver::BuildConsPosXJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                              const tConsDesc &cons_desc) {
    assert(static_cast<int>(cons_desc(eConsDescType)) == eConsTypePosX);
...
Eigen::MatrixXd cIKSolver::BuildConsPosYJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                              const tConsDesc &cons_desc) {
    assert(static_cast<int>(cons_desc(eConsDescType)) == eConsTypePosY);
...
Eigen::MatrixXd cIKSolver::BuildConsThetaJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                               const tConsDesc &cons_desc) {
    assert(static_cast<int>(cons_desc(eConsDescType)) == eConsTypeTheta);
...
Eigen::MatrixXd cIKSolver::BuildConsThetaWorldJacob(const Eigen::MatrixXd &joint_mat, const Eigen::VectorXd &pose,
                                                    const tConsDesc &cons_desc) {
    assert(static_cast<int>(cons_desc(eConsDescType)) == eConsTypeThetaWorld);
