...
int cNNController::GetPoliStateSize() const { return 0; }

int cNNController::GetPoliActionSize() const { return 0; }

int cNNController::GetNetInputSize() const { return GetPoliStateSize(); }

int cNNController::GetNetOutputSize() const { return GetPoliActionSize(); }
...
double cNNController::CalcReward() const { return 0; }

double cNNController::CalcActionLogp() const { return 0; }

bool cNNController::IsOffPolicy() const { return false; }
...
void cNNController::LoadModel(const std::string &model_file) { mNet->LoadModel(model_file); }

void cNNController::LoadScale(const std::string &scale_file) { mNet->LoadScale(scale_file); }

void cNNController::CopyNet(const cNeuralNet &net) { mNet->CopyModel(net); }

void cNNController::SaveNet(const std::string &out_file) const { mNet->OutputModel(out_file); }
...
const std::unique_ptr<cNeuralNet> &cNNController::GetNet() const { return mNet; }

bool cNNController::HasNet() const { return (mNet != nullptr) && mNet->HasNet(); }
