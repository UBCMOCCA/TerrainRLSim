...
int cPerturbManager::GetNumPerturbs() const { return static_cast<int>(mPerturbs.size()); }

const tPerturb &cPerturbManager::GetPerturb(int i) const { return mPerturbs[i]; }
