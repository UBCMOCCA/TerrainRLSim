...
cDogControllerCacla::cDogControllerCacla() : cTerrainRLCharController(), cDogController(), cBaseControllerCacla() {
...
bool cDogControllerCacla::IsCurrActionCyclic() const { return false; }
