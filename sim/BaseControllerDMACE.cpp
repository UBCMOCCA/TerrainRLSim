...
bool cBaseControllerDMACE::ValidCritic() const { return mCriticNet->HasNet(); }
...
void cBaseControllerDMACE::LoadCriticModel(const std::string &model_file) { mCriticNet->LoadModel(model_file); }

void cBaseControllerDMACE::CopyNet(const cNeuralNet &net) { CopyActorNet(net); }

void cBaseControllerDMACE::CopyActorNet(const cNeuralNet &net) { mNet->CopyModel(net); }

void cBaseControllerDMACE::CopyCriticNet(const cNeuralNet &net) { mCriticNet->CopyModel(net); }
...
void cBaseControllerDMACE::SetActorOutputOffsetScale(const Eigen::VectorXd &offset,
...
void cBaseControllerDMACE::SetCriticInputOffsetScale(const Eigen::VectorXd &offset,
                                                     const Eigen::VectorXd &scale) const {
    mCriticNet->SetInputOffsetScale(offset, scale);
}

void cBaseControllerDMACE::SetCriticOutputOffsetScale(const Eigen::VectorXd &offset,
                                                      const Eigen::VectorXd &scale) const {
    mCriticNet->SetOutputOffsetScale(offset, scale);
}

const std::unique_ptr<cNeuralNet> &cBaseControllerDMACE::GetActor() const { return mNet; }

const std::unique_ptr<cNeuralNet> &cBaseControllerDMACE::GetCritic() const { return mCriticNet; }

int cBaseControllerDMACE::GetActorInputSize() const { return GetPoliStateSize(); }

int cBaseControllerDMACE::GetActorOutputSize() const { return GetPoliActionSize(); }

int cBaseControllerDMACE::GetCriticInputSize() const { return GetPoliStateSize(); }

int cBaseControllerDMACE::GetCriticOutputSize() const { return 1; }
...
void cBaseControllerDMACE::BuildCriticInput(Eigen::VectorXd &out_x) const { out_x = mPoliState; }
