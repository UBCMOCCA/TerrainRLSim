...
cCtMTUTrackController::cCtMTUTrackController() : cCtController(), cCtTrackController(), cCtMTUController() {}
...
int cCtMTUTrackController::GetTargetStateOffset() const { return cCtMTUController::GetPoliStateSize(); }
