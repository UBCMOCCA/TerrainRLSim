...
#ifndef SIM_BIPEDCONTROLLER3D_H_
#define SIM_BIPEDCONTROLLER3D_H_
...
class cBipedController3D : public virtual cTerrainRLCharController
{
public:
	...
	enum eStateParam
	{
		eStateParamRootPitchX,
		eStateParamRootPitchY,
		eStateParamRootPitchZ,
		eStateParamRootPitchTheta,
		eStateParamStanceHipSagital,
		eStateParamStanceHipCoronal,
		eStateParamStanceKneeZ,
		eStateParamStanceAnkleX,
		eStateParamStanceAnkleY,
		eStateParamStanceAnkleZ,
		eStateParamStanceAnkleTheta,
		eStateParamSwingHipSagital,
		eStateParamSwingHipCoronal,
		eStateParamSwingKneeZ,
		eStateParamSwingAnkleX,
		eStateParamSwingAnkleY,
		eStateParamSwingAnkleZ,
		eStateParamSwingAnkleTheta,
		eStateParamMax
	};
	...
	virtual tVector computePDTorque(const tQuaternion& qRel, const tQuaternion& qRelD, const tVector& wRel, const tVector& wRelD, const cPDController& params) const;
...
protected:
	...
	virtual tQuaternion GetTargetRootPitch3D() const;
	virtual double GetRootPitch() const;
	virtual tQuaternion GetRootRot3D() const;
...
#endif /* SIM_BIPEDCONTROLLER3D_H_ */
