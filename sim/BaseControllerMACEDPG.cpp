...
int cBaseControllerMACEDPG::GetNumActionFrags() const { return mNumActionFrags; }

int cBaseControllerMACEDPG::GetActionFragSize() const { return GetPoliActionSize(); }

int cBaseControllerMACEDPG::GetNetOutputSize() const { return GetActorOutputSize(); }

int cBaseControllerMACEDPG::GetActorOutputSize() const { return GetNumActionFrags() * GetActionFragSize(); }

int cBaseControllerMACEDPG::GetCriticInputSize() const { return GetPoliStateSize() + GetPoliActionSize(); }

void cBaseControllerMACEDPG::BuildActorOutputOffsetScale(Eigen::VectorXd &out_offset,
...
void cBaseControllerMACEDPG::BuildActionFragOutputOffsetScale(Eigen::VectorXd &out_offset,
                                                              Eigen::VectorXd &out_scale) const {
...
void cBaseControllerMACEDPG::CalcCriticVals(const Eigen::VectorXd &state, const Eigen::VectorXd &actions,
...
void cBaseControllerMACEDPG::DecideAction(tAction &out_action) { DecideActionBoltzmann(out_action); }
