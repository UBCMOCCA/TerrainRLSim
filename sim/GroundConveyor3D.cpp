...
int cGroundConveyor3D::tStrip::GetNumSlices() const { return static_cast<int>(mSliceObstacles.size()); }
...
void cGroundConveyor3D::tStrip::IncHead() { mHead = (mHead + 1) % GetNumSlices(); }

cGroundConveyor3D::cGroundConveyor3D() {}

cGroundConveyor3D::~cGroundConveyor3D() {}

cGroundConveyor3D::eClass cGroundConveyor3D::GetGroundClass() const { return eClassConveyor3D; }
...
int cGroundConveyor3D::GetNumStrips() const { return static_cast<int>(mStrips.size()); }
