...
const Eigen::VectorXd &cCtTrackController::GetTargetPose() const { return mTargetPose; }

const Eigen::VectorXd &cCtTrackController::GetTargetVel() const { return mTargetVel; }
...
int cCtTrackController::GetTargetStateOffset() const { return cCtController::GetPoliStateSize(); }
