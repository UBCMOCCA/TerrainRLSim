...
bool cSimBiped2D::HasStumbled() const {
    ...
    for (int i = 0; i < cSimBiped2D::eJointMax; ++i) {
        ...
        if (joint_id != cSimBiped2D::eJointRightAnkle && joint_id != cSimBiped2D::eJointLeftAnkle &&
            joint_id != cSimBiped2D::eJointLeftKnee && joint_id != cSimBiped2D::eJointRightKnee) {
...
bool cSimBiped2D::FailFallMisc() const {
    ...
    if (this->GetRootVel()[0] < 0.0) { // Moving backwards
        fallen |= true;
    }
