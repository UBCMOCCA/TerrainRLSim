...
cBaseControllerCacla::cBaseControllerCacla() : cTerrainRLCharController() { mExpParams.mBaseActionRate = 0.2; }
...
int cBaseControllerCacla::GetPoliActionSize() const { return GetNumOptParams(); }

void cBaseControllerCacla::RecordPoliAction(Eigen::VectorXd &out_action) const { BuildOptParams(out_action); }

bool cBaseControllerCacla::ValidCritic() const { return mCriticNet->HasNet(); }
...
void cBaseControllerCacla::LoadCriticModel(const std::string &model_file) { mCriticNet->LoadModel(model_file); }

void cBaseControllerCacla::CopyNet(const cNeuralNet &net) { CopyActorNet(net); }

void cBaseControllerCacla::CopyActorNet(const cNeuralNet &net) { mNet->CopyModel(net); }

void cBaseControllerCacla::CopyCriticNet(const cNeuralNet &net) { mCriticNet->CopyModel(net); }
...
void cBaseControllerCacla::SetActorOutputOffsetScale(const Eigen::VectorXd &offset,
...
void cBaseControllerCacla::SetCriticInputOffsetScale(const Eigen::VectorXd &offset,
                                                     const Eigen::VectorXd &scale) const {
    mCriticNet->SetInputOffsetScale(offset, scale);
}

void cBaseControllerCacla::SetCriticOutputOffsetScale(const Eigen::VectorXd &offset,
                                                      const Eigen::VectorXd &scale) const {
...
const std::unique_ptr<cNeuralNet> &cBaseControllerCacla::GetActor() const { return mNet; }

const std::unique_ptr<cNeuralNet> &cBaseControllerCacla::GetCritic() const { return mCriticNet; }

int cBaseControllerCacla::GetActorInputSize() const { return GetPoliStateSize(); }

int cBaseControllerCacla::GetActorOutputSize() const { return GetPoliActionSize(); }

int cBaseControllerCacla::GetCriticInputSize() const { return GetPoliStateSize(); }

int cBaseControllerCacla::GetCriticOutputSize() const { return 1; }
...
void cBaseControllerCacla::EvalNet(const Eigen::VectorXd &x, Eigen::VectorXd &out_y) const { mNet->Eval(x, out_y); }
...
void cBaseControllerCacla::BuildCriticInput(Eigen::VectorXd &out_x) const { out_x = mPoliState; }
