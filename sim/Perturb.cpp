...
tPerturb::tPerturb(ePerturb type, cSimObj *obj, const tVector &local_pos, const tVector &perturb, double duration)
    : tPerturb() {
...
bool tPerturb::IsValid() const { return (mObj != nullptr) && (mType != ePerturbInvalid); }
