...
cDogControllerMACE::cDogControllerMACE() : cTerrainRLCharController(), cDogController(), cBaseControllerMACE() {
...
bool cDogControllerMACE::IsCurrActionCyclic() const { return false; }
