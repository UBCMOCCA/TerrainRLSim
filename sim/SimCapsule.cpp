...
double cSimCapsule::GetHeight() const { return mWorld->GetCapsuleHeight(this); }

double cSimCapsule::GetRadius() const { return mWorld->GetCapsuleRadius(this); }

cSimCapsule::eShape cSimCapsule::GetShape() const { return eShapeCapsule; }
