...
cCtPDTrackTargetController::cCtPDTrackTargetController()
    : cCtController(), cCtTargetController(), cCtPDTrackController() {}
...
int cCtPDTrackTargetController::GetTargetPosStateOffset() const { return cCtPDTrackController::GetPoliStateSize(); }
