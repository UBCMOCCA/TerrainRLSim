...
class cGroundDynamicObstacles3D : public cGroundPlane {
  public:
    ...
    virtual void SampleHeightVel(const tVector &pos, double &out_h, tVector &out_vel, bool &out_valid_sample) const;
  ...
  protected:
    struct tObstacle {
        ...
        enum eDir { eDirForward, eDirBackward, eDirMax };

        enum eMove { eMovePingPong, eMoveForward, eMoveMax };
