...
void cCtCtrlUtil::BuildBoundsTorque(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
...
void cCtCtrlUtil::BuildBoundsVel(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                 Eigen::VectorXd &out_max) {
    int joint_dim = cKinTree::GetParamSize(joint_mat, joint_id);
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildBoundsPD(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    switch (joint_type) {
    case cKinTree::eJointTypeRevolute:
...
void cCtCtrlUtil::BuildOffsetScaleTorque(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_offset,
...
void cCtCtrlUtil::BuildOffsetScaleVel(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_offset,
                                      Eigen::VectorXd &out_scale) {
    int joint_dim = cKinTree::GetParamSize(joint_mat, joint_id);
    out_offset = Eigen::VectorXd::Zero(joint_dim);
...
void cCtCtrlUtil::BuildOffsetScalePD(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_offset,
                                     Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    switch (joint_type) {
    case cKinTree::eJointTypeRevolute:
...
void cCtCtrlUtil::BuildBoundsPDRevolute(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                        Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildBoundsPDPrismatic(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                         Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildBoundsPDPlanar(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                      Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildBoundsPDFixed(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                     Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildBoundsPDSpherical(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_min,
                                         Eigen::VectorXd &out_max) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
...
void cCtCtrlUtil::BuildOffsetScalePDRevolute(const Eigen::MatrixXd &joint_mat, int joint_id,
                                             Eigen::VectorXd &out_offset, Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    assert(joint_type == cKinTree::eJointTypeRevolute);
...
void cCtCtrlUtil::BuildOffsetScalePDPrismatic(const Eigen::MatrixXd &joint_mat, int joint_id,
                                              Eigen::VectorXd &out_offset, Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    assert(joint_type == cKinTree::eJointTypePrismatic);
...
void cCtCtrlUtil::BuildOffsetScalePDPlanar(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_offset,
                                           Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    assert(joint_type == cKinTree::eJointTypePlanar);
...
void cCtCtrlUtil::BuildOffsetScalePDFixed(const Eigen::MatrixXd &joint_mat, int joint_id, Eigen::VectorXd &out_offset,
                                          Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    assert(joint_type == cKinTree::eJointTypeFixed);
...
void cCtCtrlUtil::BuildOffsetScalePDSpherical(const Eigen::MatrixXd &joint_mat, int joint_id,
                                              Eigen::VectorXd &out_offset, Eigen::VectorXd &out_scale) {
    cKinTree::eJointType joint_type = cKinTree::GetJointType(joint_mat, joint_id);
    assert(joint_type == cKinTree::eJointTypeSpherical);
