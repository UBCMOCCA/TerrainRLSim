...
cCtPhaseController::cCtPhaseController() : cCtController() { mCycleDur = 1; }
...
void cCtPhaseController::SetCycleDur(double dur) { mCycleDur = dur; }

double cCtPhaseController::GetCycleDur() const { return mCycleDur; }
...
#if defined(ENABLE_PHASE_STATE_BINS)
int cCtPhaseController::GetNumPhaseBins() const { return gNumPhaseBins; }
#endif // ENABLE_PHASE_STATE_BINS
