...
cCtNPDTrackController::cCtNPDTrackController() : cCtController(), cCtTrackController(), cCtNPDController() {}
...
int cCtNPDTrackController::GetPDStateOffset() const { return cCtTrackController::GetPoliStateSize(); }
