...
const std::string gMiscParamsNames[cBipedController::eMiscParamMax] = {"TransTime", "Cv", "Cd", "ForceX", "ForceY"};

const std::string gStateParamNames[cBipedController::eStateParamMax] = {"RootPitch",  "SpineCurve", "StanceHip",
                                                                        "StanceKnee", "SwingHip",   "SwingKnee"};
...
const cSimBiped::eJoint gSpineJoints[] = {cSimBiped::eJointSpine0, cSimBiped::eJointSpine1, cSimBiped::eJointSpine2,
...
void cBipedController::Update(double time_step) { cTerrainRLCharController::Update(time_step); }
...
void cBipedController::TransitionState(int state) { cTerrainRLCharController::TransitionState(state); }
...
int cBipedController::GetNumStates() const { return eStateMax; }
...
int cBipedController::GetDefaultAction() const { return mDefaultAction; }
...
int cBipedController::GetNumActions() const { return static_cast<int>(mActions.size()); }
...
void cBipedController::ReadParams(const std::string &file) { cTerrainRLCharController::ReadParams(file); }
...
cBipedController::eStance cBipedController::GetStance() const { return mStance; }

double cBipedController::GetPrevCycleTime() const { return mPrevCycleTime; }

const tVector &cBipedController::GetPrevDistTraveled() const { return mPrevDistTraveled; }
...
bool cBipedController::HasCtrlParams() const { return mCtrlParams.size() > 0; }
...
void cBipedController::ApplyStanceFeedback(Eigen::VectorXd &out_tau) {
    ...
    const int root_joints[] = {
        cSimBiped::eJointRightHip, cSimBiped::eJointLeftHip,
...
const cBipedController::tStateDef &cBipedController::GetCurrStateDef() const { return gStateDefs[mState]; }
...
double cBipedController::GetTransTime() const { return mCurrAction.mParams[eMiscParamTransTime]; }

double cBipedController::GetCv() const { return mCurrAction.mParams[eMiscParamCv]; }

double cBipedController::GetCd() const { return mCurrAction.mParams[eMiscParamCd]; }
...
const std::string &cBipedController::GetStateName(eState state) const { return gStateDefs[state].mName; }

const std::string &cBipedController::GetStateParamName(eStateParam param) const { return gStateParamNames[param]; }
...
void cBipedController::BuildStateParamsFromPose(const Eigen::VectorXd &pose, tStateParams &out_params) {
    const cSimBiped::eJoint ctrl_joints[] = {
        cSimBiped::eJointRightHip, cSimBiped::eJointRightKnee,
        // cSimBiped::eJointRightAnkle,
        cSimBiped::eJointLeftHip, cSimBiped::eJointLeftKnee,
        // cSimBiped::eJointLeftAnkle,
    };
...
const Eigen::VectorXd &cBipedController::GetCtrlParams(int ctrl_id) const { return mCtrlParams[ctrl_id]; }
...
void cBipedController::ApplyAction(int action_id) { cTerrainRLCharController::ApplyAction(action_id); }
...
void cBipedController::PostProcessAction(tAction &out_action) const { PostProcessParams(out_action.mParams); }
...
void cBipedController::FlipStance() { SetStance((mStance == eStanceRight) ? eStanceLeft : eStanceRight); }
...
bool cBipedController::HasCommands() const { return !mCommands.empty(); }
