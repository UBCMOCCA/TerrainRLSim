...
bool cTerrainRLCtrlFactory::BuildBipedController3D(const tCtrlParams& params, std::shared_ptr<cCharController>&
out_ctrl)
{
        bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildBipedController3DCACLA(const tCtrlParams &params,
                                                        std::shared_ptr<cCharController> &out_ctrl) {
    bool succ = true;

    std::shared_ptr<cBipedController3DCACLA> ctrl =
        std::shared_ptr<cBipedController3DCACLA>(new cBipedController3DCACLA());
    ctrl->SetGround(params.mGround);
    ctrl->Init(params.mChar.get(), params.mGravity, params.mCtrlParamFile);
...
bool cTerrainRLCtrlFactory::BuildCtRNNController(const tCtrlParams &params,
                                                 std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtVelController(const tCtrlParams &params,
                                                 std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtNPDController(const tCtrlParams &params,
                                                 std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtMTUController(const tCtrlParams &params,
                                                 std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtTrackController(const tCtrlParams &params,
                                                   std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtPDTrackController(const tCtrlParams &params,
                                                     std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtVelTrackController(const tCtrlParams &params,
                                                      std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtNPDTrackController(const tCtrlParams &params,
                                                      std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtMTUTrackController(const tCtrlParams &params,
                                                      std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtPhaseController(const tCtrlParams &params,
                                                   std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtVelPhaseController(const tCtrlParams &params,
                                                      std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtQPDController(const tCtrlParams &params,
                                                 std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtQVelController(const tCtrlParams &params,
                                                  std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtQTrackController(const tCtrlParams &params,
                                                    std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtQPDTrackController(const tCtrlParams &params,
                                                      std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtQVelTrackController(const tCtrlParams &params,
                                                       std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;

    std::shared_ptr<cCtQVelTrackController> ctrl =
        std::shared_ptr<cCtQVelTrackController>(new cCtQVelTrackController());
    ctrl->SetGround(params.mGround);
    ctrl->Init(params.mChar.get(), params.mGravity, params.mCtrlParamFile);
    ctrl->SetUpdatePeriod(update_period);
...
bool cTerrainRLCtrlFactory::BuildCtTargetController(const tCtrlParams &params,
                                                    std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtPDTrackTargetController(const tCtrlParams &params,
                                                           std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;

    std::shared_ptr<cCtPDTrackTargetController> ctrl =
        std::shared_ptr<cCtPDTrackTargetController>(new cCtPDTrackTargetController());
    ctrl->SetGround(params.mGround);
    ctrl->Init(params.mChar.get(), params.mGravity, params.mCtrlParamFile);
    ctrl->SetUpdatePeriod(update_period);
...
bool cTerrainRLCtrlFactory::BuildCtPDPhaseTargetController(const tCtrlParams &params,
                                                           std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildWaypointController(const tCtrlParams &params,
                                                    std::shared_ptr<cCharController> &out_ctrl) {
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildWaypointVelController(const tCtrlParams &params,
                                                       std::shared_ptr<cCharController> &out_ctrl) {
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildSoccerController(const tCtrlParams &params,
                                                  std::shared_ptr<cCharController> &out_ctrl) {
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildBipedStepController3D(const tCtrlParams &params,
                                                       std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtTargetTerrController(const tCtrlParams &params,
                                                        std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
...
bool cTerrainRLCtrlFactory::BuildCtTargetSoccerController(const tCtrlParams &params,
                                                          std::shared_ptr<cCharController> &out_ctrl) {
    const double update_period = 1 / params.mCtQueryRate;
    bool succ = true;
