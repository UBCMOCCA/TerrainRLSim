...
const std::string gMiscParamsNames[cBipedController2D::eMiscParamMax] = {"TransTime", "Cv", "Cd", "ForceX", "ForceY"};

const std::string gStateParamNames[cBipedController2D::eStateParamMax] = {
    "RootPitch", "StanceHip", "StanceKnee", "StanceAnkle", "SwingHip", "SwingKnee", "SwingAnkle",
};
...
void cBipedController2D::Update(double time_step) { cTerrainRLCharController::Update(time_step); }
...
void cBipedController2D::TransitionState(int state) { cTerrainRLCharController::TransitionState(state); }
...
int cBipedController2D::GetNumStates() const { return eStateMax; }
...
int cBipedController2D::GetDefaultAction() const { return mDefaultAction; }
...
int cBipedController2D::GetNumActions() const { return static_cast<int>(mActions.size()); }
...
void cBipedController2D::ReadParams(const std::string &file) { cTerrainRLCharController::ReadParams(file); }
...
cBipedController2D::eStance cBipedController2D::GetStance() const { return mStance; }

double cBipedController2D::GetPrevCycleTime() const { return mPrevCycleTime; }

const tVector &cBipedController2D::GetPrevDistTraveled() const { return mPrevDistTraveled; }
...
bool cBipedController2D::HasCtrlParams() const { return mCtrlParams.size() > 0; }
...
void cBipedController2D::ApplyStanceFeedback(Eigen::VectorXd &out_tau) {
    ...
    const int root_joints[] = {
        cSimBiped2D::eJointRightHip, cSimBiped2D::eJointLeftHip,
...
const cBipedController2D::tStateDef &cBipedController2D::GetCurrStateDef() const { return gStateDefs[mState]; }
...
double cBipedController2D::GetTransTime() const { return mCurrAction.mParams[eMiscParamTransTime]; }

double cBipedController2D::GetCv() const { return mCurrAction.mParams[eMiscParamCv]; }

double cBipedController2D::GetCd() const { return mCurrAction.mParams[eMiscParamCd]; }
...
const std::string &cBipedController2D::GetStateName(eState state) const { return gStateDefs[state].mName; }

const std::string &cBipedController2D::GetStateParamName(eStateParam param) const { return gStateParamNames[param]; }
...
void cBipedController2D::BuildStateParamsFromPose(const Eigen::VectorXd &pose, tStateParams &out_params) {
    const cSimBiped2D::eJoint ctrl_joints[] = {
        cSimBiped2D::eJointRightHip, cSimBiped2D::eJointRightKnee, cSimBiped2D::eJointRightAnkle,
        cSimBiped2D::eJointLeftHip,  cSimBiped2D::eJointLeftKnee,  cSimBiped2D::eJointLeftAnkle,
    };
...
const Eigen::VectorXd &cBipedController2D::GetCtrlParams(int ctrl_id) const { return mCtrlParams[ctrl_id]; }
...
void cBipedController2D::ApplyAction(int action_id) { cTerrainRLCharController::ApplyAction(action_id); }
...
void cBipedController2D::PostProcessAction(tAction &out_action) const { PostProcessParams(out_action.mParams); }
...
void cBipedController2D::FlipStance() { SetStance((mStance == eStanceRight) ? eStanceLeft : eStanceRight); }
...
bool cBipedController2D::HasCommands() const { return !mCommands.empty(); }
