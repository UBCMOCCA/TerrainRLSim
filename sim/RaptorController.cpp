...
const std::string gMiscParamsNames[cRaptorController::eMiscParamMax] = {"TransTime", "Cv", "Cd", "ForceX", "ForceY"};

const std::string gStateParamNames[cRaptorController::eStateParamMax] = {
    "RootPitch", "SpineCurve", "StanceHip", "StanceKnee", "StanceAnkle", "SwingHip", "SwingKnee", "SwingAnkle"};
...
const cSimRaptor::eJoint gSpineJoints[] = {cSimRaptor::eJointSpine0, cSimRaptor::eJointSpine1, cSimRaptor::eJointSpine2,
...
bool cRaptorController::LoadParams(const std::string &param_file) {
...
void cRaptorController::Update(double time_step) { cTerrainRLCharController::Update(time_step); }

void cRaptorController::UpdateCalcTau(double time_step, Eigen::VectorXd &out_tau) {
...
void cRaptorController::UpdateApplyTau(const Eigen::VectorXd &tau) {
    mTau = tau;
...
void cRaptorController::TransitionState(int state) { cTerrainRLCharController::TransitionState(state); }
...
int cRaptorController::GetNumStates() const { return eStateMax; }
...
int cRaptorController::GetDefaultAction() const { return mDefaultAction; }
...
int cRaptorController::GetNumActions() const { return static_cast<int>(mActions.size()); }
...
void cRaptorController::ReadParams(const std::string &file) { cTerrainRLCharController::ReadParams(file); }
...
cRaptorController::eStance cRaptorController::GetStance() const { return mStance; }

double cRaptorController::GetPrevCycleTime() const { return mPrevCycleTime; }

const tVector &cRaptorController::GetPrevDistTraveled() const { return mPrevDistTraveled; }
...
bool cRaptorController::HasCtrlParams() const { return mCtrlParams.size() > 0; }
...
void cRaptorController::ApplyStanceFeedback(Eigen::VectorXd &out_tau) {
    ...
    const int root_joints[] = {
        cSimRaptor::eJointRightHip, cSimRaptor::eJointLeftHip,
...
const cRaptorController::tStateDef &cRaptorController::GetCurrStateDef() const { return gStateDefs[mState]; }
...
double cRaptorController::GetTransTime() const { return mCurrAction.mParams[eMiscParamTransTime]; }

double cRaptorController::GetCv() const { return mCurrAction.mParams[eMiscParamCv]; }

double cRaptorController::GetCd() const { return mCurrAction.mParams[eMiscParamCd]; }
...
const std::string &cRaptorController::GetStateName(eState state) const { return gStateDefs[state].mName; }

const std::string &cRaptorController::GetStateParamName(eStateParam param) const { return gStateParamNames[param]; }
...
void cRaptorController::BuildStateParamsFromPose(const Eigen::VectorXd &pose, tStateParams &out_params) {
    const cSimRaptor::eJoint ctrl_joints[] = {
        cSimRaptor::eJointRightHip, cSimRaptor::eJointRightKnee, cSimRaptor::eJointRightAnkle,
        cSimRaptor::eJointLeftHip,  cSimRaptor::eJointLeftKnee,  cSimRaptor::eJointLeftAnkle,
    };
...
const Eigen::VectorXd &cRaptorController::GetCtrlParams(int ctrl_id) const { return mCtrlParams[ctrl_id]; }
...
void cRaptorController::ApplyAction(int action_id) { cTerrainRLCharController::ApplyAction(action_id); }
...
void cRaptorController::PostProcessAction(tAction &out_action) const { PostProcessParams(out_action.mParams); }
...
void cRaptorController::FlipStance() { SetStance((mStance == eStanceRight) ? eStanceLeft : eStanceRight); }
...
bool cRaptorController::HasCommands() const { return !mCommands.empty(); }
