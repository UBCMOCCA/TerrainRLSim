...
void cCtTargetSoccerController::SetBall(const std::shared_ptr<cSimObj> &ball) { mBall = ball; }
...
void cCtTargetSoccerController::BuildNNInputOffsetScaleTypes(
...
int cCtTargetSoccerController::GetGroundSampleRes() const { return 0; }
...
int cCtTargetSoccerController::GetBallStateOffset() const { return cCtPDPhaseTargetController::GetPoliStateSize(); }

int cCtTargetSoccerController::GetBallStateSize() const { return static_cast<int>(eBallStateMax); }
