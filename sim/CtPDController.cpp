...
void cCtPDController::UpdateBuildTau(double time_step, Eigen::VectorXd &out_tau) { UpdatePDCtrls(time_step, out_tau); }
...
void cCtPDController::BuildJointActionOffsetScale(int joint_id, Eigen::VectorXd &out_offset,
...
int cCtPDController::RetargetJointID(int joint_id) const { return joint_id; }
