...
void cGroundHills3D::Init(std::shared_ptr<cWorld> world, const tParams &params, const tVector &bound_min,
...
void cGroundHills3D::Clear() { cGroundVar3D::Clear(); }

cGroundHills3D::eClass cGroundHills3D::GetGroundClass() const { return eClassHills3D; }
