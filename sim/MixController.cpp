...
const Eigen::VectorXd &cMixController::GetTau(int id) const { return mTaus[id]; }

int cMixController::GetNumControllers() const { return static_cast<int>(mControllers.size()); }
...
void cMixController::SetWeight(int id, double w) { mWeights[id] = w; }
