...
class cMusculotendonUnit : public cController {
  public:
    enum eOptParam { eOptParamOptCELength, eOptParamSlackLength, eOptParamForceMax, eOptParamMax };

    enum eOptSegParam { eOptSegParamArm, eOptSegParamThetaMax, eOptSegParamThetaRest, eOptSegParamMax };
