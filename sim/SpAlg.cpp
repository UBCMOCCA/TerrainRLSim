...
cSpAlg::tSpVec cSpAlg::BuildSV(const tVector &v) { return BuildSV(tVector::Zero(), v); }
...
void cSpAlg::SetOmega(const tVector &o, tSpVec &out_sv) { out_sv.block(0, 0, 3, 1) = o.block(0, 0, 3, 1); }
...
void cSpAlg::SetV(const tVector &v, tSpVec &out_sv) { out_sv.block(3, 0, 3, 1) = v.block(0, 0, 3, 1); }

cSpAlg::tSpTrans cSpAlg::BuildTrans() { return BuildTrans(tMatrix::Identity(), tVector::Zero()); }
...
cSpAlg::tSpTrans cSpAlg::BuildTrans(const tVector &r) { return BuildTrans(tMatrix::Identity(), r); }
...
void cSpAlg::SetRot(const tMatrix &E, tSpTrans &out_X) { out_X.block(0, 0, 3, 3) = E.block(0, 0, 3, 3); }
...
void cSpAlg::SetRad(const tVector &r, tSpTrans &out_X) { out_X.block(0, 3, 3, 1) = r.block(0, 0, 3, 1); }
