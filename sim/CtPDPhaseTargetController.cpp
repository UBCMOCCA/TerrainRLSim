...
cCtPDPhaseTargetController::cCtPDPhaseTargetController()
    : cCtController(), cCtTargetController(), cCtPDPhaseController() {}
...
int cCtPDPhaseTargetController::GetTargetPosStateOffset() const { return cCtPDPhaseController::GetPoliStateSize(); }
