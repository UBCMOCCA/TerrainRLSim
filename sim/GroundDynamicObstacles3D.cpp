...
int cGroundDynamicObstacles3D::GetNumObstacles() const { return static_cast<int>(mObstacles.size()); }

const cSimObj &cGroundDynamicObstacles3D::GetObj(int i) const { return *mObstacles[i].mObj; }
...
void cGroundDynamicObstacles3D::SetChar(const std::shared_ptr<cSimCharacter> &character) { mChar = character; }

cGroundDynamicObstacles3D::eClass cGroundDynamicObstacles3D::GetGroundClass() const { return eClassDynamicObstacles3D; }

int cGroundDynamicObstacles3D::GetBlendParamSize() const { return static_cast<int>(cTerrainGen3D::eParamsMax); }

tVector cGroundDynamicObstacles3D::GetCharPos() const { return mChar->GetRootPos(); }
...
void cGroundDynamicObstacles3D::ClearObstacles() { mObstacles.clear(); }

void cGroundDynamicObstacles3D::SortObstacles() {
    std::sort(mObstacles.begin(), mObstacles.end(), [](const tObstacle &a, const tObstacle &b) {
        tVector aabb_min0;
        tVector aabb_max0;
        tVector aabb_min1;
        tVector aabb_max1;
...
void cGroundDynamicObstacles3D::BuildObstacle(tObstacle &out_obstacle) {
    ...
    tVector size =
        tVector(mRand.RandDouble(min_w, max_w), mRand.RandDouble(min_h, max_h), mRand.RandDouble(min_w, max_w), 0);
