...
cDogControllerMACEDPG::cDogControllerMACEDPG()
    : cTerrainRLCharController(), cDogControllerDPG(), cBaseControllerMACEDPG() {}
...
int cDogControllerMACEDPG::AssignFragID(int a_id) const { return cMathUtil::RandInt(0, GetNumActionFrags()); }
