...
class cTerrainGen2D {
  public:
    ...
    typedef double (*tTerrainFunc)(double width, const Eigen::VectorXd &params, cRand &rand,
    ...
    static double BuildNarrowGaps(double width, const Eigen::VectorXd &params, cRand &rand,
                                  std::vector<float> &out_data);

    static double BuildSlopes(double width, const Eigen::VectorXd &params, cRand &rand, std::vector<float> &out_data);
    static double BuildSlopesGaps(double width, const Eigen::VectorXd &params, cRand &rand,
                                  std::vector<float> &out_data);
    static double BuildSlopesSteps(double width, const Eigen::VectorXd &params, cRand &rand,
                                   std::vector<float> &out_data);
    static double BuildSlopesWalls(double width, const Eigen::VectorXd &params, cRand &rand,
                                   std::vector<float> &out_data);
    static double BuildSlopesMixed(double width, const Eigen::VectorXd &params, cRand &rand,
                                   std::vector<float> &out_data);
    static double BuildSlopesNarrowGaps(double width, const Eigen::VectorXd &params, cRand &rand,
                                        std::vector<float> &out_data);
    ...
    static void OverlaySlopes(double delta_range, double delta_min, double delta_max, double init_slope, int beg_idx,
                              int end_idx, cRand &rand, std::vector<float> &out_data);
    static void OverlayBumps(double min_delta_h, double max_delta_h, int beg_idx, int end_idx, cRand &rand,
                             std::vector<float> &out_data);
