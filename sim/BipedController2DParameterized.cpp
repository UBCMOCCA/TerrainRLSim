...
cBipedController2DParameterized::cBipedController2DParameterized()
    : cBipedController2DCACLA() //, _rand(14)
{
...
tVector cBipedController2DParameterized::GetTargetVel() const { return tVector(_target_vel, 0, 0, 0); }
...
void cBipedController2DParameterized::updateInternalState(Eigen::VectorXd &state) { this->_target_vel = state(0); }
