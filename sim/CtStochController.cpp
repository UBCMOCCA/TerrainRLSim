...
int cCtStochController::GetNoiseStateOffset() const { return cCtController::GetPoliStateSize(); }

int cCtStochController::GetNoiseStateSize() const { return GetNumNoiseUnits(); }

int cCtStochController::GetNoiseActionOffset() const { return cCtController::GetPoliActionSize(); }

int cCtStochController::GetNoiseActionSize() const { return GetNumNoiseUnits(); }
