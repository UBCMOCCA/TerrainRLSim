...
void cCtTargetController::SetTargetPos(const tVector &pos) { mTargetPos = pos; }
...
int cCtTargetController::GetTargetPosStateOffset() const { return cCtController::GetPoliStateSize(); }

int cCtTargetController::GetTargetPosStateSize() const { return gTargetPosDim; }
