...
cMusculotendonUnit::tParams::tParams() { Clear(); }
...
double cMusculotendonUnit::GetRefStrain() { return gRefStrain; }

cMusculotendonUnit::cMusculotendonUnit() : cController() {
    Clear();
    mActivationRate = 100;
}
...
void cMusculotendonUnit::UpdateApplyTau(const Eigen::VectorXd &tau) { mChar->ApplyControlForces(tau); }

int cMusculotendonUnit::GetNumAttachPts() const { return static_cast<int>(mParams.mAttachPts.size()); }
...
double cMusculotendonUnit::GetCELength() const { return mCELength; }

double cMusculotendonUnit::GetOptCELength() const { return mParams.mOptCELength; }

double cMusculotendonUnit::GetSlackLength() const { return mParams.mSlackLength; }
...
double cMusculotendonUnit::GetActivation() const { return mActivation; }

void cMusculotendonUnit::SetExcitation(double u) { mExcitation = u; }

double cMusculotendonUnit::GetExcitation() const { return mExcitation; }
...
int cMusculotendonUnit::GetNumSegs() const { return GetNumAttachPts() - 1; }
