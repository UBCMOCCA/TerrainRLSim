...
void cSimCharSoftFall::EnableDistFall(bool enable) { mEnableFallDist = enable; }

void cSimCharSoftFall::EnableSoftContact(bool enable) { mEnableSoftContact = enable; }

void cSimCharSoftFall::ResetFallDistCounter() { mFallDistCounter = gFallDistCheckPeriod; }

bool cSimCharSoftFall::FailFallDist() const { return mFailFallDist; }
...
void cSimCharSoftFall::ResetFallContactCounter() { mFallContatCounter = gFallContactCheckPeriod; }
...
bool cSimCharSoftFall::FailFallMisc() const { return false; }
