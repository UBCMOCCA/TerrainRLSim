...
FILE *cFileUtil::OpenFile(const std::string &file_name, const char *mode) { return OpenFile(file_name.c_str(), mode); }
...
void cFileUtil::CreateFile(const std::string &file_name) { ClearFile(file_name); }
...
/*
bool cFileUtil::ReadArray(FILE* f, const std::string& tag_beg, const std::string& tag_end, std::vector<double>&
out_buffer)
{
